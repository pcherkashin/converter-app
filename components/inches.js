...
export default function InchConverter() {
    ...
    const handleVal1Change = (event) => {
      ...
      setVal1Error(false)
      setVal1(val1Value)
    const setValue = (val1Value * 2.54)    // centimeters = inches * 2.54
  ...
  const handleVal2Change = (event) => {
    ...
    if (val2Value < 0) {
      ...
      setVal2Error(false)
    setVal2(val2Value)
    const setValue = (val2Value / 2.54) // inches = centimeters / 2.54
  ...
  return (
    <div className={styles.container}>
      ...
      <label htmlFor="val1" className={styles.label}>Inches</label>
        ...
        <div className={styles.column}>
        <label htmlFor="val2" className={styles.label}>Centimeters</label>
        <input
          className={styles.input}
          type="number"
          id="val2"
